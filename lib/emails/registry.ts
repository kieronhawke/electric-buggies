...
export const TEMPLATES: TemplateMeta[] = [
  ...
  { key: "quote-received", name: "Quote request received", purpose: "Auto-reply confirming a quote request", trigger: "Quote request submitted", subject: "Thank you, we have your request", preheader: "We have your request and one of our specialists is reviewing it." },
