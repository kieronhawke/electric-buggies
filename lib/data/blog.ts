...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "cta", title: "Plan your event fleet", text: "Tell us the event, dates and what you need to move, and we will size a fleet, with drivers if you want them. Request a tailored quote.", href: "/request-a-quote", label: "Request a quote", secondaryHref: "/sectors/events", secondaryLabel: "Explore events" },
      { type: "faq", items: [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "cta", title: "Plan your venue shuttle", text: "Tell us the journeys people make and how you want to fund the service, and we will help plan and specify it. Request a tailored quote.", href: "/request-a-quote", label: "Request a quote", secondaryHref: "/sectors/venues", secondaryLabel: "Explore venues" },
      { type: "faq", items: [
