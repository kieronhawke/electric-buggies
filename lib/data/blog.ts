...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Not every low-speed vehicle is treated the same way. Single-seat machines, very slow vehicles and certain mobility-type vehicles can fall under different rules from a multi-seat passenger buggy, and the speed a vehicle is capable of affects which category and approval apply. A buggy built only for private land is generally not designed to be retro-fitted to full road standard, which is why road use is usually specified from the outset rather than added later. Because the detail varies, the specifics for any given model are best confirmed for that vehicle. [CONFIRM: which low-speed vehicle category and approval route apply to each specific model]." },
