...
export const locations: Location[] = [
  {
    ...
    faqs: [
      ...
      { q: "How much do they cost?", a: "Pricing is in GBP, with the two-seat from £11,500, the four-seat from £14,900, the utility from £15,900, the six-seat from £18,900 and the eight-seat from £23,500, before specification and branding. Custom builds are quoted to your brief, and we aim to beat any genuine like-for-like quote. There is no import duty or overseas freight to add for UK delivery." },
    ],
  },
  {
    slug: "dubai",
    ...
    faqs: [
      ...
      { q: "What currency do you quote in?", a: "Pricing is quoted in GBP, with an AED equivalent provided on request. From-prices start at £11,500 for the two-seat and rise with size and specification, before branding and freight. Custom builds are quoted to your brief." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What currency do you quote in?", a: "Pricing is quoted in GBP, with a local equivalent provided on request. From-prices start at £11,500 for the two-seat and rise with size and specification, before branding and freight. Custom builds are quoted to your brief." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What currency do you quote in?", a: "Pricing is quoted in GBP, with a USD equivalent provided on request. From-prices start at £11,500 for the two-seat and rise with size and specification, before branding and freight. Custom builds are quoted to your brief." },
    ],
    currencyNote: "Pricing quoted in GBP; USD equivalent provided on request.",
  },
];
