...
export const MODEL_SEO: Record<string, ModelSeo> = {
  "the-two": {
    ...
    description:
      "Our 2 seater electric golf buggy: compact, quiet and beautifully finished, with bespoke fleet branding, a 3-year warranty and 24-hour VIP support.",
  },
  "the-four": {
    keyword: "4 Seater Electric Golf Buggy",
    descriptor: "A Refined 4 Seater Electric Golf Buggy",
    description:
      "Our 4 seater electric golf buggy: refined and quiet, built for estates, resorts and clubs, with bespoke fleet branding and a 3-year warranty.",
  },
  "the-six": {
    keyword: "6 Seater Electric Buggy",
    descriptor: "A Spacious 6 Seater Electric Buggy",
    description:
      "Our 6 seater electric buggy for larger groups across estates, resorts and venues, with bespoke fleet branding and a 3-year warranty.",
  },
  "the-eight": {
    keyword: "8 Seater Electric Buggy",
    descriptor: "Our Flagship 8 Seater Electric Buggy",
    description:
      "Our flagship 8 seater electric buggy for shuttle and group transport, with bespoke branding, a 3-year warranty and 24-hour VIP support.",
  },
  "the-utility": {
    keyword: "Electric Utility Vehicle UK",
    descriptor: "A Hard-Working Electric Utility Vehicle",
    description:
      "Our electric utility vehicle for estates, farms, grounds and work sites: cargo-ready, quiet and tough, with a 3-year warranty and VIP support.",
  },
  bespoke: {
